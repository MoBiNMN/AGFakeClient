...
public:
	...
	virtual void Disconnect( unsigned int blockDuration, unsigned char orderingChannel=0, bool forceExit = false)=0;
	...
	// AGSAMP Added
	virtual int GetLastRPCID(void) = 0;
	virtual int GetLastPacketID(void) = 0;
};
